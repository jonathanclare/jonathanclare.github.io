...
* State in Notes.js probably became overly complex - would probably refactor - maybe just pass around a copy of the current note.
* Default strings should be placeholders instead.
* Formatting of text from textarea to maintain paragraphs.
* Add Travis CI for automated building and testing and to set up gh-pages branch for viewing in same repo as source code at.
* The note id should be autogenerated in the redux store.
